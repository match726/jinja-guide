...
const ShrineCard: React.FC<Props> = (props) => {
  return (
    <Link href={props.cardLink} passHref>
      <Card className="w-full max-w-md mx-auto bg-red-50 dark:bg-gray-800 hover:bg-red-100 hover:border-red-900 overflow-hidden group">
